...
def generate_cult_autogen_files(config: str, local_config: str, base_mod_path: str):
    ...
    with Writer(base_mod_path / "localisation/english/zz_evolved_autogenerated_cult_l_english.yml") as writer:
        ...
        for cult, _, _, _ in cults:
            writer.write_localization(f"tec_has_{cult}", f"$tec_has_empire_cult$ ['tradition:tec_cult_{cult}']")
            ...
            writer.write_localization(f"tec_has_last_activated_{cult}", f"$tec_has_empire_cult$ ['tradition:tec_cult_{cult}']")
            writer.write_localization(f"tec_has_last_deactivated_{cult}", f"$tec_has_empire_cult$ ['tradition:tec_cult_{cult}']")
