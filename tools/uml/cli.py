...
def generate_cult_autogen_files(config: str, local_config: str, base_mod_path: str):
    ...
    with Writer(base_mod_path / "localisation/english/zz_evolved_autogenerated_cult_l_english.yml") as writer:
        ...
        for cult, _, _, _ in cults:
            writer.write_localization(f"tec_has_{cult}", f"$tec_has_empire_cult$ ['tradition:tec_cult_{cult}', $tec_cult_{cult}$]")
            writer.write_localization(f"tec_has_{cult}_yes", f"£trigger_yes£ $tec_has_empire_cult$ ['tradition:tec_cult_{cult}', $tec_cult_{cult}$]")
            writer.write_localization(f"tec_has_{cult}_no", f"£trigger_no£ $tec_has_empire_cult$ ['tradition:tec_cult_{cult}', $tec_cult_{cult}$]")
            writer.write_localization(f"tec_activate_cult_{cult}", f"$tec_activate_cult_effect$ ['tradition:tec_cult_{cult}', $tec_cult_{cult}$]")
            writer.write_localization(f"tec_deactivate_cult_{cult}", f"$tec_deactivate_cult_effect$ ['tradition:tec_cult_{cult}', $tec_cult_{cult}$]")
            writer.write_localization(f"tec_has_last_activated_{cult}", f"$tec_has_empire_last_activated_cult$ ['tradition:tec_cult_{cult}', $tec_cult_{cult}$]")
            writer.write_localization(f"tec_has_last_activated_{cult}_yes", f"£trigger_yes£ $tec_has_empire_last_activated_cult$ ['tradition:tec_cult_{cult}', $tec_cult_{cult}$]")
            writer.write_localization(f"tec_has_last_activated_{cult}_no", f"£trigger_no£ $tec_has_empire_last_activated_cult$ ['tradition:tec_cult_{cult}', $tec_cult_{cult}$]")
            writer.write_localization(f"tec_has_last_deactivated_{cult}", f"$tec_has_empire_last_deactivated_cult$ ['tradition:tec_cult_{cult}', $tec_cult_{cult}$]")
            writer.write_localization(f"tec_has_last_deactivated_{cult}_yes", f"£trigger_yes£ $tec_has_empire_last_deactivated_cult$ ['tradition:tec_cult_{cult}', $tec_cult_{cult}$]")
            writer.write_localization(f"tec_has_last_deactivated_{cult}_no", f"£trigger_no£ $tec_has_empire_last_deactivated_cult$ ['tradition:tec_cult_{cult}', $tec_cult_{cult}$]")
            writer.write_localization(f"tec_has_cult_points_available_{cult}", f"$tec_has_cult_points_available$ ['tradition:tec_cult_{cult}', $tec_cult_{cult}$]")
            writer.write_localization(f"tec_has_cult_points_available_{cult}_yes", f"£trigger_yes£ $tec_has_cult_points_available$ ['tradition:tec_cult_{cult}', $tec_cult_{cult}$]")
            writer.write_localization(f"tec_has_cult_points_available_{cult}_no", f"£trigger_no£ $tec_has_cult_points_available$ ['tradition:tec_cult_{cult}', $tec_cult_{cult}$]")
